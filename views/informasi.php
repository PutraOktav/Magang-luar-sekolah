      ...
      <section class="container mx-auto px-4">
          <div class="bg-white p-6 rounded-lg shadow-lg mb-8">
              ...
              <ul class="list-disc pl-5">
                  <li class="mb-2">
                      <strong>Pengumuman Terbaru:</strong> Kami telah meluncurkan produk baru yang akan membantu Anda meningkatkan efisiensi bisnis Anda.
                  </li>
                  <li class="mb-2">
                      <strong>Event dan Seminar:</strong> Kami akan mengadakan seminar tentang teknologi terkini dan cara menggunakannya untuk meningkatkan bisnis Anda.
                  </li>
                  <li class="mb-2">
                      <strong>Artikel dan Studi Kasus:</strong> Kami telah menerbitkan beberapa artikel dan studi kasus terbaru tentang proyek-proyek kami yang sukses. Anda dapat membacanya di sini.
                  </li>
                  <li class="mb-2">
                      <strong>Pelatihan Online:</strong> Kami akan mengadakan pelatihan online yang mencakup berbagai topik teknologi terkini.
                  </li>
                  <li class="mb-2">
                      <strong>Kolaborasi dengan Startup Lokal:</strong> Kami telah bermitra dengan beberapa startup lokal untuk mengembangkan solusi teknologi yang inovatif.
                  </li>
                  <li class="mb-2">
                      <strong>Perluasan Layanan:</strong> Kami telah memperluas layanan kami ke beberapa kota utama di Indonesia.
                  </li>
              </ul>
          </div>
