            ...
            <div id="jobContainer" class="bg-white p-6 rounded-lg shadow-lg">
                ...
                ?>
                        ...
                        <article class="job-item mb-6 p-4 border rounded-lg shadow hover:shadow-lg transition duration-300 flex flex-col">
                            ...
                            <button class="text-blue-500 underline hover:text-blue-700 transition duration-300 self-end" onclick="toggleDetails('desc-<?php echo $row['id']; ?>', this)">Baca selengkapnya</button>
                        </article>
                <?php
                    }
                    echo '</div>';
