...
INSERT INTO `berita` (`id_berita`, `judul_berita`, `isi_berita`, `selengkap`, `tanggal_publikasi`, `foto_berita`) VALUES
...
INSERT INTO `galeri` (`id_gambar`, `nama_galeri`, `category`) VALUES
	(1, 'photo1.jpg', 'foto'),
	(2, 'photo2.jpg', 'foto'),
	(3, 'photo3.jpg', 'foto'),
	(4, 'photo4.jpg', 'foto'),
...
CREATE TABLE IF NOT EXISTS `karir` (
  `id_karir` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `karir` (`id_karir`, `nama_karir`, `deskripsi_karir`, `selengkapnya`) VALUES
...
INSERT INTO `program` (`id_program`, `nama_program`, `deskripsi`, `jadwal`, `biaya`, `materi`, `foto`, `id_pelatih`) VALUES
	...
	(2, 'Sistem Informasi Terintegrasi', 'Pelatihan ini mencakup desain dan implementasi sistem informasi yang dapat meningkatkan efisiensi bisnis Anda.', 'Setiap Selasa & Kamis, 18:00 - 20:00', 4000000, 'Pemodelan Data, Integrasi Sistem, Keamanan Sistem Informasi ', 'program2.jpg', 3),
...
CREATE TABLE IF NOT EXISTS `program_user` (
  ...
  KEY `id_user` (`id_user`),
  KEY `id_program` (`id_program`),
  CONSTRAINT `fk_program_user_program` FOREIGN KEY (`id_program`) REFERENCES `program` (`id_program`),
...
INSERT INTO `program_user` (`id_proser`, `id_user`, `id_program`, `role`) VALUES
	(1, 3, 3, '3'),
	(2, 3, 2, '3'),
	(3, 2, 1, '2');
...
-- Membuang data untuk tabel db_lembaga_pelatihan.users: ~7 rows (lebih kurang)
INSERT INTO `users` (`id`, `username`, `password`, `alamat`, `no_telp`, `email`, `foto`, `role`) VALUES
	(1, 'Oktav', '90da9876474dc0f3783baa0d3bc79fcfbb660dee7bdbfdfac193a07e813a2d33', 'Jl.  No.1', '0811111', 'oktav@nokt.tech', 'oktav.jpeg', '2'),
